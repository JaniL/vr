...
// module.exports.getStationInfo('LH', function(info) { console.log(util.inspect(info, false, null)); });
// module.exports.getTrains(function(info) { console.log(util.inspect(info, false, null)); });
// module.exports.getTrain('H337', function(info) { console.log(info); });
